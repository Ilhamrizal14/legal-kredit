            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="tgl_masuk" class="col-md-4 control-label">TANGGAL MASUK</label>
                        <div class="col-md-8">
                ...
                <div class="modal-footer">
                    ...
                    <form id="jaminan_masuk-form" action="{{ route('jaminan_masuk.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Form fields -->
