    ...
    <ul class="nav navbar-nav ml-auto">
        ...
        <li class="dropdown user user-menu">
            <a href="#" class="" data-toggle="dropdown">
                <img src="{{ asset('storage/management_user/foto_profil/' . (auth()->user()->foto ?? 'user_image.jpg')) }}" class="user-image mt-1" alt="User Image">
                <span class="text-white">{{ auth()->user()->name }}</span>
            </a>
            <ul class="dropdown-menu bg-dark">
                <!-- User image -->
                <li class="user-header">
                    <img src="{{ asset('storage/management_user/foto_profil/' . (auth()->user()->foto ?? 'user_image.jpg')) }}" class="img-circle" alt="User Image">
